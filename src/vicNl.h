...
double calc_snow_coverage(int *, double, double, double, double, double, double,
                          ...
                          double *);
double calc_snow_ground_flux(int, int, int, int, double, double, double, double,
                             double, double *, double *, double *, double *,
...
double canopy_evap(layer_data_struct *, layer_data_struct *, veg_var_struct *,
                   veg_var_struct *, char, int, int, double, double *, double,
                   double, double, double, double, double, double, double,
                   double, double, double *, double *, double *, double *,
...
int dist_prec(atmos_data_struct *, dist_prcp_struct *, soil_con_struct *,
              veg_con_struct *, lake_con_struct *, dmy_struct *,
              global_param_struct *, filep_struct *, out_data_file_struct *,
              out_data_struct *, save_data_struct *, int, int, char, char,
              char *, int *);
int distribute_node_moisture_properties(double *, double *, double *, double *,
                                        ...
                                        double *, double *, double *, double *,
                                        double *, int, int, char);
void distribute_soil_property(double *, double, double, double **l_param, int,
                              int, double *, double *);
...
int initialize_model_state(dist_prcp_struct *, dmy_struct,
                           ...
                           char **, int **);
int initialize_new_storm(cell_data_struct ***, veg_var_struct ***, int, int,
                         int, double, double);
...
int put_data(dist_prcp_struct *, atmos_data_struct *, soil_con_struct *,
             veg_con_struct *, lake_con_struct *, out_data_file_struct *,
...
void redistribute_moisture(layer_data_struct *, double *, double *, double *,
                           double *, double *, int);
...
double root_brent(double, double, char *, double (*Function)(double,
                                                             va_list), ...);
int runoff(cell_data_struct *, cell_data_struct *, energy_bal_struct *,
           soil_con_struct *, double *, double *, double, int, int, int, int,
           int);
...
int snow_intercept(double, double, double, double, double, double, double,
                   ...
                   double *, double *, double *, double *, double *, double *,
                   double *, double *, double *, double *, double *, double *,
                   double *, double *, char *, int *, double *, double *,
                   double *, double *, double *, double *, float *, int, int,
...
double solve_snow(char, double, double, double, double, double, double, double,
                  ...
                  layer_data_struct *, snow_data_struct *, soil_con_struct *,
...
int surface_fluxes(char, double, double, double, double, double, double,
                   ...
                   atmos_data_struct *, dmy_struct *, energy_bal_struct *,
...
int update_thermal_nodes(dist_prcp_struct *, int, int, int, soil_con_struct *,
                         veg_con_struct *);
void usage(char *);
