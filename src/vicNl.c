    ...
    while (!MODEL_DONE) {
        ...
        if (RUN_MODEL) {
            ...
            **************************************************/
            ...
            initialize_atmos(atmos, dmy, filep.forcing, &soil_con,
                             out_data_files, out_data);
            ...
            if (!options.OUTPUT_FORCE) {
                ...
                **************************************************/
...
#endif /* VERBOSE */
                ErrorFlag = initialize_model_state(&prcp, dmy[0], &global_param,
                                                   filep,
                                                   soil_con.gridcel,
                ...
                ErrorFlag = dist_prec(&atmos[0], &prcp, &soil_con, veg_con,
                                      ...
                                      cellnum,
                                      NEWCELL, LASTREC, init_STILL_STORM,
                                      init_DRY_TIME);
                ...
                ******************************************/
                ...
                for (rec = startrec; rec < global_param.nrecs; rec++) {
                    ...
                    ErrorFlag = dist_prec(&atmos[rec], &prcp, &soil_con,
                                          veg_con,
                                          &lake_con, dmy, &global_param, &filep,
