    ...
    ******************************************************************/
    ...
    if (options.QUICK_FLUX) {
        ...
        if (options.DIST_PRCP) {
            ErrorFlag = estimate_layer_ice_content_quick_flux(layer_dry,
                                                              soil_con->depth,
                                                              soil_con->dp,
                                                              energy->T[0],
                                                              energy->T[1],
        ...
        ErrorFlag = estimate_layer_ice_content(layer_wet, soil_con->Zsum_node,
                                               energy->T,
        ...
        if (options.DIST_PRCP) {
            ErrorFlag = estimate_layer_ice_content(layer_dry,
                                                   soil_con->Zsum_node,
                                                   energy->T,
                                                   soil_con->max_moist_node,
                                                   soil_con->expt_node,
