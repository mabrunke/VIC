...
void create_cn_output_list(out_data_struct *, int);
...
void init_output_list(out_data_struct *, int, char *, int, double, int, int);
...
void set_cn_output_defaults(out_data_file_struct *, out_data_struct *);
